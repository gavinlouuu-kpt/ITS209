...
void test_sensor_initialization()
{
    ...
    // Verify sensor type
    sht4_precision_t precision = sht4.getPrecision();
    TEST_ASSERT_TRUE_MESSAGE(precision >= SHT4X_PRECISION_HIGH && precision <= SHT4X_PRECISION_LOW, 
...
void test_sensor_precision()
{
    ...
    sht4.setPrecision(SHT4X_PRECISION_HIGH);
